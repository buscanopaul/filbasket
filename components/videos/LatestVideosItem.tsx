      ...
      <Link href={`/videos/${1}`}>
        <div>
          <div
            ...
            className={`xl:h-44 h-60 bg-secondary-color bg-cover bg-no-repeat bg-center rounded-md hover:!bg-[url(https://i.ytimg.com/an_webp/51cm2-pToVM/mqdefault_6s.webp?du=3000&sqp=CM_h2JoG&rs=AOn4CLAT6Gl9GIlGf6Fzpa9hRkV6ri1x-A)] transition-all duration-500 ease-in-out`}
          >
